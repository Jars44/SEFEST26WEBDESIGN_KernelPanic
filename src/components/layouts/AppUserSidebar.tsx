...
const navItems = [
  ...
  { label: "Gadget Saya", href: "/user/inventoris", icon: Smartphone },
  { label: "Riwayat Servis", href: "/user/servis", icon: ClipboardList },
  { label: "Jejak Hijau", href: "/user/dampak", icon: Leaf },
];
...
export default function AppUserSidebar() {
