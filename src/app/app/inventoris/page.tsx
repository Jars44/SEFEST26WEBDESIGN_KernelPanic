    ...
    <main className="p-8 font-sans">
      ...
      <Card className="border border-[#e6e6ea] shadow-[0_2px_15px_rgba(0,0,0,0.03)] rounded-2xl bg-white">
        <CardContent className="p-0 overflow-x-auto">
          <div className="min-w-150 grid grid-cols-[1fr_120px_80px_140px_80px] gap-4 px-6 py-3 border-b border-[#f2f3f5]">
          ...
          {parts.map((p, i) => (
            <div
              key={i}
              className="min-w-150 grid grid-cols-[1fr_120px_80px_140px_80px] gap-4 px-6 py-4 border-b border-[#f2f3f5] last:border-0 items-center hover:bg-[#fbfbfd] transition-colors"
            >
